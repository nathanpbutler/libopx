...
* **Line and Packet ANSI output** - Both `Line.ToString()` and `Packet.ToString()` now use `Constants.T42_DEFAULT_COLORS` for consistent ANSI color formatting starting from the timecode prefix.
...
[unreleased]: https://github.com/nathanpbutler/libopx/compare/v2.4.2...HEAD
[2.4.2]: https://github.com/nathanpbutler/libopx/compare/v2.4.1...v2.4.2
