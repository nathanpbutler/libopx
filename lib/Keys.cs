...
public class Keys
{
    ...
    /// <summary>
    /// Footer Partition Pack Key (Open Incomplete)
    /// </summary>
    public static readonly byte[] FooterPartitionPackOpenIncomplete =
        [0x06, 0x0E, 0x2B, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0D, 0x01, 0x02, 0x01, 0x01, 0x04, 0x01, 0x00];

    /// <summary>
    /// Footer Partition Pack Key (Closed Incomplete)
    /// </summary>
    public static readonly byte[] FooterPartitionPackClosedIncomplete =
        [0x06, 0x0E, 0x2B, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0D, 0x01, 0x02, 0x01, 0x01, 0x04, 0x02, 0x00];

    /// <summary>
    /// Footer Partition Pack Key (Open Complete)
    /// </summary>
    public static readonly byte[] FooterPartitionPackOpenComplete =
        [0x06, 0x0E, 0x2B, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0D, 0x01, 0x02, 0x01, 0x01, 0x04, 0x03, 0x00];
